...
export function PlaceholderPage({
  ...
  return (
    <section
      className="relative isolate overflow-hidden bg-secondary py-32"
      ...
      <div className="container relative mx-auto grid gap-16 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <h1
            ...
            className="text-5xl font-semibold tracking-[-0.08em] text-foreground"
          >
            {title}
          </h1>
        ...
        <div className="flex flex-col justify-end gap-6 text-sm uppercase tracking-[0.28em] text-foreground/70">
          <p>
            We're curating this experience next. In the meantime, explore our
            hero showcase or connect with us for bespoke event concepts tailored
            to your needs.
          </p>
